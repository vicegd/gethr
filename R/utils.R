...
get_post <- function(method, params = list()) {
  ...
  #print(body_json)
  response = httr::POST(url = gethr_env$rpc_address, content_type_json(), body = body_json)
...
#'
#' \code{get_rpc_address} returns the RPC address that is being used to connect to the Geth node.
#'
#' @family utils functions
#'
...
#'
#' @return Boolean - \code{true} if the input is a whole number, \code{false} otherwise.
#'
#' @examples
#' is.wholenumber(20)
#' is.wholenumber(20.3)
...
#'
#' \code{set_rpc_address} sets the RPC address that is being used to connect to the Geth node.
#'
#' @family utils functions
#'
...
#'
#' \code{process_block} returns the values of the block in plain text or decimal if possible. The values are obtained from the Geth node.
#'
#' @family utils functions
#'
#' @param block Objects - Information of the block in hexadecimal.
#'
#' @return Object - Information of the block with values in plain text or decimal if possible.
...
#'
#' \code{process_block} returns the values of the log in decimal if possible. The values are obtained from the Geth node.
#'
#' @family utils functions
#'
...
#'
#' \code{process_block} returns the values of the receipts in plain text or decimal if possible. The values are obtained from the Geth node.
#'
#' @family utils functions
#'
#' @param receipt Objects - Information of the receipt in hexadecimal.
#'
#' @return Object - Information of the receipt with values in plain text or decimal if possible.
...
#'
#' \code{process_block} returns the values of the transactions in plain text or decimal if possible. The values are obtained from the Geth node.
#'
#' @family utils functions
#'
#' @param trans Objects - Information of the transaction in hexadecimal.
#'
#' @return Object - Information of the transaction with values in plain text or decimal if possible.
